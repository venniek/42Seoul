...
void benchmark_map(void) {
  ...
  std = map_insert_growing(20000, std_map);
  std::cout << "std: " << std << std::endl;
  ft = map_insert_growing(20000, ft_map);
...
void benchmark_stack(void) {
  ...
  std = stack_insert_growing(20000, std_stack);
  std::cout << "std: " << std << std::endl;
  ft = stack_insert_growing(20000, ft_stack);
  std::cout << "ft: " << ft << std::endl;
  if (static_cast<double>(ft) / static_cast<double>(std) < 1.0000) {
...
void benchmark_vector(void) {
  ...
  std = vector_insert_growing(20000, std_vector);
  std::cout << "std: " << std << std::endl;
  ft = vector_insert_growing(20000, ft_vector);
  std::cout << "ft: " << ft << std::endl;
  if (static_cast<double>(ft) / static_cast<double>(std) < 1.0000) {
